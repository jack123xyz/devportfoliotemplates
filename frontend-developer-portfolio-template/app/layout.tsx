...
export const metadata: Metadata = {
  title: "Jack Anderson - Frontend Developer",
  description:
  ...
  authors: [{ name: "Jack Anderson" }],
  creator: "Jack Anderson",
  openGraph: {
    title: "Jack Anderson - Frontend Developer Portfolio",
    description:
    ...
    url: "https://jack123.xyz",
    siteName: "Jack Anderson - Portfolio",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Jack Anderson - Frontend Developer Portfolio",
      },
    ],
    locale: "en_US",
    type: "website",
