    ...
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative p-12 rounded-3xl overflow-hidden  border border-gray-800 bg-gradient-to-br bg-gradient-to-r from-night to-black opacity-30"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-hacker-green-dark via-night to-hacker-green-light/10" />
          ...
          <div className="relative z-10">
            ...
            >
              <h2 className="text-4xl font-bold mb-3 text-center bg-gradient-to-r from-hacker-green-light via-hacker-green-medium to-hacker-green-light text-transparent bg-clip-text">
                Let&apos;s Connect
              </h2>
              <p className="text-lavender-light text-center mb-4">
                Need help with a project or just want to chat? Don&apos;t
              ...
              <div className="flex items-center justify-center gap-2 text-gray-400 mb-8">
                ...
                <span>Jonesborough, TN</span>
              </div>
            </motion.div>
            <div className="flex flex-col items-center gap-6 mb-8">
              <motion.a
                href="mailto:jackanderson1302000@gmail.com"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-hacker-green via-hacker-green-light to-hacker-green-dark rounded-2xl hover:from-hacker-green-light hover:via-hacker-green hover:to-hacker-green-light transition-all duration-300 font-medium text-white"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <motion.a
                href="https://github.com/jack123xyz"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
